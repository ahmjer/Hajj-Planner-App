...
# -------------------------------------------------------------------
# التهيئة والدوال (تم تصحيح دالة distribute_staff لضمان إغلاق القوس)
# -------------------------------------------------------------------
...
def distribute_staff(total_basic_staff, ratio_supervisor, ratio_assistant_head, ratio_head):
    ...
    return {
        ...
        "مقدم خدمة": مقدم_خدمة, 
        "اداري": إداري
    } # القوس الختامي للقاموس

# تحديد الإدارات وتصنيفها - المعايير النهائية المطلوبة (بدون تغيير)
DEPARTMENTS = {
    "مراكز الضيافة": [
        {"name": "مركز الضيافة", "type": "Ratio", "default_ratio": 75, "default_coverage": 100}, 
    ],
    "الاستقبال والمغادرة": [
        {"name": "استقبال الهجرة", "type": "Ratio", "default_ratio": 100, "default_coverage": 3
