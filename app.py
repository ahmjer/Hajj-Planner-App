...
# 📌 إضافة الهيدر المخصص (خط عودي ثابت)
st.markdown("""
<style>
/* إنشاء ديف (div) ثابت أعلى الصفحة ليكون الخط العودي */
.custom-header-line {
    position: fixed;
    top: 0;
    left: 0;
...
/* إزاحة المحتوى الرئيسي للأسفل لتجنب التداخل مع الشريط الجديد */
.main > div {
    padding-top: 30px; /* ازاحة المحتوى لأسفل > ارتفاع الخط 20px */
}
</style>
""", unsafe_allow_html=True)

# 📌 حقن عنصر الخط في الصفحة
st.markdown('<div class="custom-header-line"></div>', unsafe_allow_html=True)


# كود CSS المعدّل لإخفاء المحتوى الأولي للشريط الجانبي
st.markdown("""
<style>
...
/* 2. تثبيت الشريط الجانبي (Sidebar) على اليمين لضمان العرض السليم */
...
/* 3. تعديل محتوى الشريط الجانبي ليكون RTL */
/* 4. إخفاء محتوى الشريط الجانبي بشكل مطلق قبل معالجته */
...
/* 5. إظهار أيقونة القائمة (Hamburger Menu) في مكانها الصحيح في RTL */
