...
def distribute_staff(total_basic_staff, ratio_supervisor, ratio_assistant_head, ratio_head):
    ...
    return {
        'مقدم خدمة': مقدم_خدمة, # تم تعديل التسمية هنا
        'مشرف ميداني': math.ceil(مشرفون_اجمالي * 0.7), # تم تعديل التسمية هنا
        'مشرف اداري': مشرفون_اجمالي - math.ceil(مشرفون_اجمالي * 0.7), # تم تعديل التسمية هنا
        'مساعد رئيس': مساعد_رئيس, # تم تعديل التسمية هنا
        'رئيس': رئيس,
        'اداري': إداري # تم تعديل التسمية هنا
    }
